...
const DisciplinaryActionPage: React.FC<{ onNavigate: (page: Page) => void; onBack: () => void; }> = ({ onNavigate, onBack }) => {
    return (
        <div className="animate-fade-in min-h-screen bg-slate-950 relative overflow-hidden selection:bg-indigo-500/30 selection:text-white">
             {/* Background Effects */}
            <div className="absolute top-[-10%] right-[-5%] w-[500px] h-[500px] bg-red-600/5 rounded-full blur-[100px] pointer-events-none"></div>
            <div className="absolute bottom-[-10%] left-[-5%] w-[500px] h-[500px] bg-orange-600/5 rounded-full blur-[100px] pointer-events-none"></div>
            ...
            <div className="shrink-0 relative z-40 pt-8 pb-4">
                <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <h1 className="text-4xl md:text-5xl font-extrabold text-white tracking-tight mb-3">
                        Disciplinary <span className="text-transparent bg-clip-text bg-gradient-to-r from-red-400 to-orange-400">Action</span>
                    </h1>
                     <p className="text-slate-400 text-lg max-w-2xl">Tools to handle disciplinary issues with AI-generated show-cause letters, warnings, and more.</p>
                </div>
            </div>
            <main className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 relative z-10">
                 <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-7xl mx-auto">
                    <GeneratorCard
                        ...
                        icon={getLargeGeneratorIcon('show_cause')}
                        title="Show-Cause Notice"
                        description="Generate formal notices requesting an explanation for misconduct or performance issues."
                        onClick={() => {}}
                        disabled
                    />
                    <GeneratorCard
                        ...
                        className="animate-slide-in-up"
                        icon={getLargeGeneratorIcon('warning_letter')}
                        title="Warning Letter"
                        description="Draft official warning letters for various infractions, from tardiness to policy violations."
                        onClick={() => {}}
                        disabled
                    />
                    <GeneratorCard
                        ...
                        className="animate-slide-in-up"
                        icon={getLargeGeneratorIcon('suspension_order')}
                        title="Suspension"
                        description="Create suspension notices detailing the terms, duration, and reason for the action."
                        onClick={() => {}}
                        disabled
                    />
                    <GeneratorCard
                        ...
                        className="animate-slide-in-up"
                        icon={getLargeGeneratorIcon('termination_letter')}
                        title="Termination Letter"
                        description="Produce legally compliant termination letters for employees."
                        onClick={() => {}}
                        disabled
                    />
                </div>
